...
name = "센서A"
is_ok = True
print(count, temp, name, is_ok) # 3 37 센서A True
...
#실습27
# 100, 100.0, "100" 각각 int, float, str 로 출력 예측
...
print("2" + "3") # 23
print("47" + "20") # 4720
# 숫자끼리 더하기는 계산, str끼리는 이어붙이기

# 실습29
# 3 > 2  True
print(3 > 2) # True
print(5 == 5) # True
print(type(7 > 10)) # <class 'bool'>

# 실습30
count = 3
print("count:", type(count)) # count: <class 'int'>
count = 3.0
print("count:", type(count)) # count: <class 'float'>
count = "3"
